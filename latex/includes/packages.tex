...
\usepackage[bf,sc,raggedright]{titlesec}  % raggedright avoids hyphenation of titles
\titleformat{\section}
  {\vspace{2ex}\itshape\bfseries\Large}
  {\thesection}
  {.5em}
  {}
...
\newcommand*\bibmetafield[2]
  {\\\small\color{darkgray}\mkbibbold{\mkbibacro{#1}}\addcolon\space\sffamily#2\nopunct}
...
\DeclareFieldFormat{url}{\bibmetafield{URL}{\url{#1}}}
